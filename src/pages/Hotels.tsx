...
const Hotels = () => {
  ...
  const hotels = [
    ...
    },
    {
      ...
      description: "Premium business hotel in Jamshedpur with modern conference facilities and excellent connectivity to TATA Steel",
      price: 4200,
      originalPrice: 4800,
      rating: 4.3,
      reviews: 892,
      ...
      amenities: ["WiFi", "Conference Room", "Restaurant", "Gym", "Parking", "Business Center"],
      category: "Business",
      airbnbCategory: "Business",
      verified: true,
      distance: "2.1 km from TATA Steel",
      images: [
        "https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=800&h=600&fit=crop",
        "https://images.unsplash.com/photo-1566073771259-6a8506099945?w=800&h=600&fit=crop"
      ]
    ...
    {
      id: 4,
      name: "Hotel Baidyanath Dham",
      description: "Traditional accommodation near Baidyanath Temple with authentic cultural experience and temple darshan facilities",
      price: 2200,
      originalPrice: 2800,
      rating: 4.6,
      reviews: 1847,
      ...
      amenities: ["WiFi", "Temple Access", "Vegetarian Meals", "Cultural Programs", "Parking", "Puja Arrangements"],
      category: "Temple Stay",
      airbnbCategory: "Spiritual",
      verified: true,
      distance: "0.3 km from Baidyanath Temple",
      images: [
        "https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?w=800&h=600&fit=crop",
    ...
    {
      id: 11,
      name: "Dhanbad Business Suites",
      description: "Modern business hotel with conference facilities and executive suites for corporate travelers",
      price: 3800,
      originalPrice: 4200,
      rating: 4.4,
      reviews: 145,
      location: "Dhanbad",
      image: "https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=400&h=300&fit=crop",
      amenities: ["WiFi", "Conference Room", "Business Center", "Restaurant", "Parking"],
      category: "Business",
      airbnbCategory: "Business",
      verified: true,
    ...
    {
      id: 12,
      name: "Giridih Nature Resort",
      description: "Eco-friendly resort surrounded by lush forests and natural beauty, perfect for nature lovers",
      price: 3200,
      originalPrice: 3800,
      rating: 4.7,
      reviews: 167,
      location: "Giridih",
      image: "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=400&h=300&fit=crop",
      amenities: ["WiFi", "Nature View", "Hiking Trails", "Restaurant", "Parking"],
      category: "Eco Resort",
      airbnbCategory: "Peaceful",
      verified: true,
    ...
    },
    {
      ...
      description: "Modern hotel in the heart of Bokaro with excellent connectivity to industrial areas and city center",
      price: 2800,
      originalPrice: 3200,
      rating: 4.3,
      reviews: 123,
      location: "Bokaro",
      image: "https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?w=400&h=300&fit=crop",
      amenities: ["WiFi", "Restaurant", "Gym", "Conference Room", "Parking"],
      category: "Business",
      airbnbCategory: "Business",
      verified: true,
    ...
    {
      id: 14,
      name: "Palamu Wildlife Lodge",
      description: "Wildlife lodge near Palamu Tiger Reserve with safari packages and nature activities",
      price: 3500,
      originalPrice: 4000,
      rating: 4.6,
      reviews: 98,
      ...
      airbnbCategory: "Adventure",
      verified: true,
      distance: "5.7 km from tiger reserve",
      images: [
        "https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?w=800&h=600&fit=crop",
        "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=800&h=600&fit=crop"
      ]
    ...
    {
      id: 15,
      name: "Sahibganj Riverside Hotel",
      description: "Riverside hotel with beautiful Ganges views and traditional architecture",
      price: 2200,
      originalPrice: 2600,
      rating: 4.5,
      reviews: 156,
      ...
      amenities: ["WiFi", "River View", "Restaurant", "Boat Rides", "Parking"],
      category: "Heritage",
      airbnbCategory: "Peaceful",
      verified: true,
      distance: "0.8 km from Ganges river",
      images: [
        "https://images.unsplash.com/photo-1566073771259-6a8506099945?w=800&h=600&fit=crop",
        "https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?w=800&h=600&fit=crop"
      ]
    ...
    {
      id: 16,
      name: "Chatra Hill Station Resort",
      description: "Hill station resort with panoramic views and cool climate, perfect for summer retreats",
      price: 3100,
      originalPrice: 3600,
      rating: 4.4,
      reviews: 134,
      location: "Chatra",
      image: "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=400&h=300&fit=crop",
      amenities: ["WiFi", "Mountain View", "Restaurant", "Trekking", "Parking"],
    ...
    {
      id: 17,
      name: "Koderma Diamond Hotel",
      description: "Luxury hotel in the diamond city with modern amenities and elegant interiors",
      price: 4200,
      originalPrice: 4800,
      rating: 4.7,
      reviews: 189,
      location: "Koderma",
      image: "https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=400&h=300&fit=crop",
      amenities: ["WiFi", "Spa", "Fine Dining", "Business Center", "Parking"],
      category: "Luxury",
      airbnbCategory: "Unique",
      verified: true,
    ...
    {
      id: 18,
      name: "Simdega Tribal Resort",
      description: "Authentic tribal resort offering cultural experiences and traditional accommodations",
      price: 1800,
      originalPrice: 2200,
      rating: 4.6,
      reviews: 112,
      location: "Simdega",
      image: "https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400&h=300&fit=crop",
      amenities: ["WiFi", "Cultural Shows", "Tribal Tours", "Restaurant", "Parking"],
      category: "Cultural",
      airbnbCategory: "Unique",
      verified: true,
    ...
    {
      id: 19,
      name: "Latehar Adventure Lodge",
      description: "Adventure lodge perfect for trekking and outdoor activities in the wilderness",
      price: 2500,
      originalPrice: 3000,
      rating: 4.5,
      reviews: 87,
      location: "Latehar",
      image: "https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?w=400&h=300&fit=crop",
      amenities: ["WiFi", "Adventure Tours", "Restaurant", "Camping", "Parking"],
      category: "Adventure",
      airbnbCategory: "Adventure",
      verified: true,
      distance: "15.3 km from city center",
      images: [
        "https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?w=800&h=600&fit=crop",
        "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=800&h=600&fit=crop"
      ]
    ...
    {
      id: 21,
      name: "Godda Heritage Palace",
      description: "Historic palace converted into luxury hotel with royal architecture and modern amenities",
      price: 4800,
      originalPrice: 5500,
      rating: 4.8,
      reviews: 203,
      location: "Godda",
      image: "https://images.unsplash.com/photo-1566073771259-6a8506099945?w=400&h=300&fit=crop",
      amenities: ["WiFi", "Palace Tours", "Fine Dining", "Spa", "Parking"],
      category: "Heritage",
      airbnbCategory: "Unique",
      verified: true,
    ...
    },
    {
      ...
      airbnbCategory: "Peaceful",
      verified: true,
      distance: "10.8 km from city center",
      images: [
        "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=800&h=600&fit=crop",
        "https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=800&h=600&fit=crop"
      ]
    },
    {
      ...
      location: "Garhwa",
      image: "https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=400&h=300&fit=crop",
      amenities: ["WiFi", "Conference Room", "Restaurant", "Business Center", "Parking"],
      category: "Business",
      airbnbCategory: "Business",
      verified: true,
    ...
    {
      id: 24,
      name: "Palamu Fort Hotel",
      description: "Historic fort converted into luxury hotel with ancient architecture and modern comforts",
      price: 3900,
      originalPrice: 4500,
      rating: 4.7,
      reviews: 145,
      location: "Palamu",
      image: "https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?w=400&h=300&fit=crop",
      amenities: ["WiFi", "Fort Tours", "Restaurant", "Cultural Shows", "Parking"],
      category: "Heritage",
      airbnbCategory: "Unique",
      verified: true,
    ...
    {
      id: 25,
      name: "Sahibganj Ganges View Resort",
      description: "Riverside resort with stunning Ganges views and traditional boat rides",
      price: 2700,
      originalPrice: 3200,
      rating: 4.5,
      reviews: 178,
      location: "Sahibganj",
      image: "https://images.unsplash.com/photo-1566073771259-6a8506099945?w=400&h=300&fit=crop",
      amenities: ["WiFi", "River View", "Boat Rides", "Restaurant", "Parking"],
      category: "Resort",
      airbnbCategory: "Peaceful",
      verified: true,
      distance: "0.5 km from Ganges river",
      images: [
        "https://images.unsplash.com/photo-1566073771259-6a8506099945?w=800&h=600&fit=crop",
        "https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?w=800&h=600&fit=crop"
      ]
    ...
    {
      id: 26,
      name: "Chatra Adventure Camp",
      description: "Adventure camp with trekking, camping, and outdoor activities in the hills",
      price: 1900,
      originalPrice: 2300,
      rating: 4.4,
      reviews: 89,
      location: "Chatra",
      image: "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=400&h=300&fit=crop",
      amenities: ["WiFi", "Trekking", "Camping", "Restaurant", "Parking"],
      category: "Adventure",
      airbnbCategory: "Adventure",
      verified: true,
      distance: "18.7 km from city center",
      images: [
        "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=800&h=600&fit=crop",
        "https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?w=800&h=600&fit=crop"
      ]
    ...
    {
      id: 27,
      name: "Koderma Diamond Palace",
      description: "Luxury palace hotel with diamond-themed decor and royal treatment",
      price: 5200,
      originalPrice: 6000,
      rating: 4.9,
      reviews: 234,
      location: "Koderma",
      image: "https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=400&h=300&fit=crop",
      amenities: ["WiFi", "Diamond Museum", "Fine Dining", "Spa", "Parking"],
      category: "Luxury",
      airbnbCategory: "Unique",
      verified: true,
      distance: "1.2 km from city center",
    ...
    {
      id: 28,
      name: "Simdega Tribal Village Resort",
      description: "Authentic tribal village resort with traditional huts and cultural experiences",
      price: 1600,
      originalPrice: 2000,
      rating: 4.5,
      reviews: 123,
      location: "Simdega",
      image: "https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400&h=300&fit=crop",
      amenities: ["WiFi", "Tribal Huts", "Cultural Shows", "Restaurant", "Parking"],
      category: "Cultural",
      airbnbCategory: "Unique",
      verified: true,
      distance: "8.9 km from city center",
      images: [
        "https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=800&h=600&fit=crop",
        "https://images.unsplash.com/photo-1610030469983-98e550d6193c?w=800&h=600&fit=crop"
      ]
    ...
    {
      id: 29,
      name: "Latehar Wilderness Lodge",
      description: "Wilderness lodge in the heart of nature with basic amenities and adventure activities",
      price: 1800,
      originalPrice: 2200,
      rating: 4.3,
      reviews: 76,
      location: "Latehar",
      image: "https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?w=400&h=300&fit=crop",
      amenities: ["WiFi", "Wilderness Tours", "Basic Restaurant", "Camping", "Parking"],
      category: "Wilderness",
      airbnbCategory: "Adventure",
      verified: true,
      distance: "22.1 km from city center",
      images: [
        "https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?w=800&h=600&fit=crop",
        "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=800&h=600&fit=crop"
      ]
    ...
    {
      id: 30,
      name: "Pakur Silk Heritage Hotel",
      description: "Heritage hotel showcasing local silk culture with traditional architecture and modern amenities",
      price: 2400,
      originalPrice: 2900,
      rating: 4.6,
      reviews: 156,
      location: "Pakur",
      image: "https://images.unsplash.com/photo-1610030469983-98e550d6193c?w=400&h=300&fit=crop",
      amenities: ["WiFi", "Silk Heritage", "Restaurant", "Cultural Tours", "Parking"],
      category: "Heritage",
      airbnbCategory: "Unique",
      verified: true,
      distance: "2.1 km from city center",
  ...
  const filteredHotels = selectedCategory === "all" 
    ? hotels.slice(0, 12) 
    : hotels.filter(hotel => hotel.airbnbCategory === selectedCategory).slice(0, 12);
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-12">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center">
              <h1 className="text-3xl font-bold mb-3">Find Your Perfect Stay</h1>
