            ...
            <CardContent className="p-0">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                <div className="space-y-2">
                  <label className="block text-sm font-semibold text-foreground">Search</label>
                  <div className="relative">
                    <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-muted-foreground" />
                    <Input 
                      placeholder="Find products, artisans..." 
                      className="pl-10 h-12 bg-white border-border/30 focus:border-primary/50" 
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Select value={selectedCategory} onValueChange={setSelectedCategory}>
                    <SelectTrigger className="h-12 bg-white border-border/30 focus:border-primary/50">
                ...
                <div className="flex items-end space-x-2">
                  <Button 
                    className="flex-1 h-12 tourism-button"
                  >
                    <Filter className="h-4 w-4 mr-2" />
                    Apply Filters
                  </Button>
                  
                  <div className="flex rounded-lg border border-border/30 bg-white">
                    <Button
