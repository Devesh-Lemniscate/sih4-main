                ...
                >
                  ...
                  <div className="text-center px-4 sm:px-6 lg:px-8 max-w-5xl z-10 relative">
                    ...
                    >
                      ...
                      <h1 className="text-5xl md:text-7xl font-display font-bold mb-4 leading-tight text-gradient-white">
                        {slide.title}
                      </h1>
                      <h2 className="text-6xl md:text-8xl font-display font-bold mb-6 leading-tight text-white">
                        {slide.subtitle}
                      </h2>
