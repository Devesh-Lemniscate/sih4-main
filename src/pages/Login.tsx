  ...
  const handleVerifyOtpAndSignup = async () => {
    ...
    try {
      if (activeRole === "tourist") {
        ...
        if (!res.success) throw new Error((res as any).message || "Registration failed");
  ...
  return (
    <Layout>
      <div className="h-screen flex overflow-hidden">
        ...
        >
          <div className="flex items-center justify-center p-8 text-white w-full">
            <div className="max-w-sm text-center">
              ...
              <div className="space-y-3 text-left">
                <h3 className="text-base font-semibold mb-3">Why join our community?</h3>
              ...
              <div className="mt-6 flex space-x-3">
                <Button variant="ghost" size="sm" className="text-white border-white hover:bg-white hover:text-foreground">
          ...
          <div className="w-full max-w-md">
            ...
            <div className="lg:hidden text-center mb-6">
              <div className="flex items-center justify-center mb-3">
                ...
                <span className="text-xl font-bold text-foreground">KalpanaX</span>
              </div>
            ...
            <Card className="travel-card">
              <CardContent className="p-6">
                ...
                <div className="space-y-4">
                  <Tabs value={activeRole} onValueChange={(v) => setActiveRole(v as Role)}>
                    <TabsList className="w-full grid grid-cols-3">
                      <TabsTrigger value="tourist" className={activeRole === "tourist" ? "text-primary" : ""}>
                        <User2 className="h-3 w-3 mr-1" /> Tourist
                      </TabsTrigger>
                      <TabsTrigger value="artisan" className={activeRole === "artisan" ? "text-primary" : ""}>
                        <Store className="h-3 w-3 mr-1" /> Artisan
                      </TabsTrigger>
                    ...
                    <div className="relative">
                      ...
                      >
                        ...
                        <Button variant="cultural" size="sm" className="w-full" onClick={handleLogin} disabled={loading}>
                  ...
                  {!isLogin && (
                      <TabsContent value={activeRole} className="mt-3">
                        {/* Tourist form */}
                        {activeRole === "tourist" && (
                          <div className="space-y-2 max-h-80 overflow-y-auto">
                            <div className="rounded-lg border border-border bg-accent/20 p-3">
                              <p className="text-xs text-muted-foreground">Tell us a bit about you</p>
                            </div>
                            <div className="space-y-1">
                              <Label className="text-sm">Full Name</Label>
                              <Input placeholder="John Doe" className="h-9" value={touristForm.fullName} onChange={(e) => setTouristForm({ ...touristForm, fullName: e.target.value })} />
                            </div>
                            <div className="space-y-1">
                              <Label className="text-sm">Email (required)</Label>
                              <div className="relative">
                                <Mail className="absolute left-3 top-1/2 transform -translate-y-1/2 text-muted-foreground h-4 w-4" />
                                <Input type="email" className="pl-10 h-9" value={touristForm.email} onChange={(e) => setTouristForm({ ...touristForm, email: e.target.value })} />
                              </div>
                            </div>
                            <div className="space-y-1">
                              <Label className="text-sm">Phone (optional)</Label>
                              <Input className="h-9" value={touristForm.phone} onChange={(e) => setTouristForm({ ...touristForm, phone: e.target.value })} />
                            </div>
                            <div className="space-y-1">
                              <Label className="text-sm">Address</Label>
                              <Input className="h-9" value={touristForm.address} onChange={(e) => setTouristForm({ ...touristForm, address: e.target.value })} />
                            </div>
                            <div className="space-y-1">
                              <Label className="text-sm">Gender</Label>
                              <select className="flex h-9 w-full rounded-md border border-input bg-background px-3 py-2 text-sm" value={touristForm.gender} onChange={(e) => setTouristForm({ ...touristForm, gender: e.target.value })}>
                            ...
                            <div className="space-y-1">
                              ...
                              <Input type="date" className="h-9" value={touristForm.dateOfBirth} onChange={(e) => setTouristForm({ ...touristForm, dateOfBirth: e.target.value })} />
                            </div>
                            <div className="space-y-2 pt-2">
                              <div className="rounded-md bg-orange-50 border border-orange-200 px-3 py-2">
                                <h4 className="text-xs font-medium text-orange-700">Emergency Contact</h4>
                                <p className="text-[11px] text-orange-600">Used only for safety alerts</p>
                              </div>
                              <div className="space-y-1">
                                <Label className="text-sm">Contact Name</Label>
                                <Input className="h-9" value={touristForm.emergencyContactName} onChange={(e) => setTouristForm({ ...touristForm, emergencyContactName: e.target.value })} />
                              </div>
                              <div className="space-y-1">
                                <Label className="text-sm">Contact Phone</Label>
                                <Input className="h-9" value={touristForm.emergencyContactPhone} onChange={(e) => setTouristForm({ ...touristForm, emergencyContactPhone: e.target.value })} />
                              </div>
                              <div className="space-y-1">
                                <Label className="text-sm">Relationship</Label>
                                <select className="flex h-9 w-full rounded-md border border-input bg-background px-3 py-2 text-sm" value={touristForm.emergencyContactRelation} onChange={(e) => setTouristForm({ ...touristForm, emergencyContactRelation: e.target.value })}>
                            ...
                            <div className="space-y-1">
                              ...
                              <div className="relative">
                                <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 text-muted-foreground h-4 w-4" />
                                <Input type={showPassword ? "text" : "password"} placeholder="8+ chars, letters & numbers" className="pl-10 pr-10 h-9" value={touristForm.password} onChange={(e) => setTouristForm({ ...touristForm, password: e.target.value })} />
                            ...
                            {!otpSent ? (
                              <Button onClick={handleSendOtp} disabled={loading || !touristForm.email || !touristForm.address || !touristForm.gender || !touristForm.dateOfBirth || !touristForm.emergencyContactName || !touristForm.emergencyContactPhone || !touristForm.emergencyContactRelation || !passwordValid(touristForm.password)} className="w-full h-9" variant="cultural" size="sm">
                                {loading ? <Loader2 className="h-4 w-4 animate-spin" /> : "Send Email OTP"}
                              </Button>
                            ) : (
                              <div className="space-y-2">
                                <Label className="text-sm">Enter 6-digit OTP sent to email</Label>
                                ...
                                <div className="flex items-center justify-between">
                                  <Button variant="outline" type="button" disabled={!canResend} onClick={handleSendOtp} size="sm">
                                    Resend OTP {canResend ? "" : `in ${secondsLeft}s`}
                                  </Button>
                                  <Button variant="cultural" onClick={handleVerifyOtpAndSignup} disabled={loading || otpCode.length !== 6} size="sm">
                        ...
                        {activeRole === "artisan" && (
                          <div className="space-y-2 max-h-80 overflow-y-auto">
                            <div className="rounded-lg border border-border bg-accent/20 p-3">
                              <p className="text-xs text-muted-foreground">Artisan details for marketplace verification</p>
                            </div>
                            ...
                            <div className="space-y-2">
                              <Label>Gender</Label>
                              <select className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm" value={artisanForm.gender} onChange={(e) => setArtisanForm({ ...artisanForm, gender: e.target.value })}>
                                <option value="">Select Gender</option>
                                <option value="male">Male</option>
                                <option value="female">Female</option>
                                <option value="other">Other</option>
                            ...
                            <div className="space-y-2">
                              ...
                              <Input type="date" value={artisanForm.dateOfBirth} onChange={(e) => setArtisanForm({ ...artisanForm, dateOfBirth: e.target.value })} />
                            </div>
                            <div className="space-y-4 pt-4 border-t border-border">
                              <h4 className="text-sm font-medium text-foreground">Emergency Contact Information</h4>
                              <div className="space-y-2">
                                <Label>Emergency Contact Name</Label>
                                <Input value={artisanForm.emergencyContactName} onChange={(e) => setArtisanForm({ ...artisanForm, emergencyContactName: e.target.value })} />
                              </div>
                              <div className="space-y-2">
                                <Label>Emergency Contact Phone</Label>
                                <Input value={artisanForm.emergencyContactPhone} onChange={(e) => setArtisanForm({ ...artisanForm, emergencyContactPhone: e.target.value })} />
                              </div>
                              <div className="space-y-2">
                                <Label>Relationship</Label>
                                <select className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm" value={artisanForm.emergencyContactRelation} onChange={(e) => setArtisanForm({ ...artisanForm, emergencyContactRelation: e.target.value })}>
                                  <option value="">Select Relationship</option>
                                  <option value="Father">Father</option>
                                  <option value="Mother">Mother</option>
                                  <option value="Spouse">Spouse</option>
                            ...
                            <div className="space-y-2">
                              ...
                              <Input placeholder="1234 5678 9012" value={artisanForm.aadharNumber} onChange={(e) => setArtisanForm({ ...artisanForm, aadharNumber: e.target.value })} maxLength={14} />
                            </div>
                    <div className="space-y-2">
                              <Label>Password</Label>
                      <div className="relative">
                        <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 text-muted-foreground h-4 w-4" />
                                <Input type={showPassword ? "text" : "password"} placeholder="8+ chars, letters & numbers" className="pl-10 pr-10" value={artisanForm.password} onChange={(e) => setArtisanForm({ ...artisanForm, password: e.target.value })} />
                                <Button type="button" variant="ghost" size="icon" className="absolute right-0 top-0 h-full" onClick={() => setShowPassword(!showPassword)}>
                                  {showPassword ? <EyeOff className="h-4 w-4" /> : <Eye className="h-4 w-4" />}
                                </Button>
                              </div>
                        ...
                        {activeRole === "admin" && (
                          <div className="space-y-2 max-h-80 overflow-y-auto">
                            <div className="rounded-lg border border-border bg-accent/20 p-3">
                              <p className="text-xs text-muted-foreground">Admin account for system management</p>
                            </div>
                            <div className="space-y-2">
                              <Label>Full Name</Label>
                            ...
                            <div className="space-y-2">
                              <Label>Gender</Label>
                              <select className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm" value={adminForm.gender} onChange={(e) => setAdminForm({ ...adminForm, gender: e.target.value })}>
                                <option value="">Select Gender</option>
                                <option value="male">Male</option>
                                <option value="female">Female</option>
                                <option value="other">Other</option>
                            ...
                            <div className="space-y-4 pt-4 border-t border-border">
                              ...
                              <div className="space-y-2">
                                <Label>Emergency Contact Name</Label>
                                <Input value={adminForm.emergencyContactName} onChange={(e) => setAdminForm({ ...adminForm, emergencyContactName: e.target.value })} />
                              </div>
                              <div className="space-y-2">
                                <Label>Emergency Contact Phone</Label>
                                <Input value={adminForm.emergencyContactPhone} onChange={(e) => setAdminForm({ ...adminForm, emergencyContactPhone: e.target.value })} />
                              </div>
                              <div className="space-y-2">
                                <Label>Relationship</Label>
                                <select className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm" value={adminForm.emergencyContactRelation} onChange={(e) => setAdminForm({ ...adminForm, emergencyContactRelation: e.target.value })}>
                                  <option value="">Select Relationship</option>
                                  <option value="Father">Father</option>
                                  <option value="Mother">Mother</option>
                                  <option value="Spouse">Spouse</option>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                              ...
                              <div className="space-y-2">
                                ...
                                <div className="relative">
                                  <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 text-muted-foreground h-4 w-4" />
                                  <Input type={showPassword ? "text" : "password"} placeholder="8+ chars, letters & numbers" className="pl-10 pr-10" value={adminForm.password} onChange={(e) => setAdminForm({ ...adminForm, password: e.target.value })} />
                                  <Button type="button" variant="ghost" size="icon" className="absolute right-0 top-0 h-full" onClick={() => setShowPassword(!showPassword)}>
                                    {showPassword ? <EyeOff className="h-4 w-4" /> : <Eye className="h-4 w-4" />}
                                  </Button>
                                </div>
